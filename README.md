...
Ansible project for deploying [Node-RED](https://nodered.org/) via Docker Compose on a single host.

**Target host:** `nodered.local.iamrobertyoung.co.uk`
...
├── inventories/
│   ├── hosts.yml               # Inventory with nodered group
│   └── group_vars/             # Group variables
├── host_vars/                  # Host-specific variables
├── roles/
│   └── nodered/                # Custom Node-RED role
...
| `nodered` | Custom | Node-RED deployment |
